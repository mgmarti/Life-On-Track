            ...
            <div id="card-container">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Life On Track lets you log your daily routine everywhere </p>
                </div>
              </div>
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Easily break bad habits like smoking, drinking or nail biting, or build positive habits like fitness, meditation or reading. </p>
                </div>
              </div>
            </div>
